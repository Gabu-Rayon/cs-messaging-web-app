...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 17, 2024 at 07:54 PM
...
INSERT INTO `messages` (`id`, `user_id`, `message_body`, `created_at`, `updated_at`) VALUES
(1, '208', 'So it means if u pay ua loan before the due date is a disadvantage the last time I paid earlier it was stil', NULL, NULL),
(2, '208', 'The dates of payment are still indicated n no money sent', NULL, NULL),
(3, '208', '  Why was my application rejected', NULL, NULL),
